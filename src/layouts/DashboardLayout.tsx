...
/**
 * Los módulos de licencias/dispositivos son estructura inicial (placeholders)
 * y quedan claramente marcados como próximamente. SOLO 'Descargas' y 'Mi cuenta'
 * tienen contenido funcional en esta fase.
 */
const NAV_ITEMS = [
  { to: '/dashboard/descargas', label: 'Descargas', icon: Download, soon: false },
  { to: '/dashboard/mi-cuenta', label: 'Mi cuenta', icon: User, soon: false },
  { to: '/dashboard/mi-licencia', label: 'Mi licencia', icon: KeyRound, soon: false },
  { to: '/dashboard/mis-dispositivos', label: 'Mis dispositivos', icon: MonitorSmartphone, soon: false },
]
      ...
      {open && (
        <div className="fixed inset-0 z-50 lg:hidden">
          <div
            ...
            onClick={() => setOpen(false)}
          />
          <aside id="drawer-navegacion" className="absolute inset-y-0 left-0 flex w-72 flex-col bg-surface-900">
            {sidebar}
          </aside>
        </div>
      )}
